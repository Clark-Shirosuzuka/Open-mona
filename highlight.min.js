...
var hljs = function() {
    ...
    var ne = (e=>{
        ...
        function f(e, t, i, r) {
            ...
            function g() {
                null != x.subLanguage ? (()=>{
                    ...
                    if ("string" == typeof x.subLanguage) {
                        ...
                        e = E(S, x.subLanguage.length ? x.subLanguage : null);
            ...
            function p(e) {
                return 0 === x.matcher.regexIndex ? (S += e[0],
                1) : (R = !0,
                0)
            }
            function _(e) {
        ...
        function E(e, t) {
            ...
            const a = (e=>{
              ...
              , i = t.filter(v).filter(x).map((n=>f(n, e, !1)));
            i.unshift(a);
            const r = i.sort(((e,n)=>{
    ...
    function Ne(e) {
        ...
        const m = [].concat(u, l.contains)
          ...
          , y = {
            match: n.concat(/\b/, (N = [...fe, "super"],
            n.concat("(?!", N.join("|"), ")")), t, n.lookahead(/\(/)),
    ...
    const we = e=>m(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/)
      ...
      , ze = ["iOS", "iOSApplicationExtension", "macOS", "macOSApplicationExtension", "macCatalyst", "macCatalystApplicationExtension", "watchOS", "watchOSApplicationExtension", "tvOS", "tvOSApplicationExtension", "swift"];
    var Ue = Object.freeze({
        ...
        grmr_markdown: e=>{
            ...
            i.contains.push(a);
            let r = [n, t];
            return a.contains = a.contains.concat(r),
